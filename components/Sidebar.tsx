  ...
  return (
    <aside className={`${collapsed ? 'w-20' : 'xl:w-72 md:w-20'} bg-[#0c1022] border-r border-slate-800 h-screen fixed left-0 top-0 flex flex-col z-50 select-none transition-all duration-300 ease-in-out`}>
      ...
      <button
        ...
        className="md:hidden lg:hidden xl:block absolute -right-3 top-20 bg-[#1a1a3e] border border-slate-700 text-slate-400 hover:text-white hover:bg-slate-700 transition-all rounded-full p-1.5 z-50"
